...
${OBJECTDIR}/src/TLS/Command.o: src/TLS/Command.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TLS/Command.o src/TLS/Command.cpp

${OBJECTDIR}/src/TLS/Tools.o: src/TLS/Tools.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/TLS
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TLS/Tools.o src/TLS/Tools.cpp

${OBJECTDIR}/src/TLS/Typedef.o: src/TLS/Typedef.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/TLS
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TLS/Typedef.o src/TLS/Typedef.cpp
